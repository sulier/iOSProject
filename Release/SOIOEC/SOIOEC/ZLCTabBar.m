...
- (void)setItems:(NSArray *)items
{
    ...
    for (UITabBarItem *item in items) {
        ZLCTabBarButton *button = [ZLCTabBarButton buttonWithType:UIButtonTypeCustom];
...
- (void)layoutSubviewsAnimated:(BOOL)animated
{
    ...
    ZLCTabBarButton *lastView = nil;
    for (ZLCTabBarButton *subView in self.buttons) {
